...
import { IosModal } from '@/components/bootstrap/ios-modal'
import { AndroidModal } from '@/components/bootstrap/android-modal'
...
export function LandingPage() {
    ...
    return (
        <div className="relative h-[100dvh] w-full pt-72 sm:pt-48 mb-5 bg-[#0e0f14] flex items-center justify-center overflow-y-auto selection:bg-purple-500/30">
            ...
            {/* MODALS */}
            <IosModal open={iosOpen} onOpenChange={setIosOpen} />
            <AndroidModal open={androidOpen} onOpenChange={setAndroidOpen} />
        </div>
    )
}
