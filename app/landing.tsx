...
import * as Dialog from '@radix-ui/react-dialog' // Using your existing dependency
                                                ...
                                                <Dialog.Content asChild>
                                                    ...
                                                    >
                                                        ...
                                                        <Dialog.Description className="mt-4 text-slate-300 leading-relaxed">
                                                            ...
                                                            We are currently in our <span className="text-purple-400 font-bold">Bootstrap Phase</span> to fund final infrastructure and delivery.
                                                        </Dialog.Description>
                                                        ...
                                                        <div className="mt-6 p-4 bg-purple-500/10 rounded-xl border border-purple-500/20 flex items-start gap-3">
                                                            ...
                                                            <p className="text-xs text-slate-400">
                                                                Support our early contributors and participate in the Dutch Auction to help us clear the final hurdle for the App Store.
                                                            </p>
                                                        </div>

                                                        <div className="mt-8 flex flex-col gap-3">
                                                            <Link href="https://sansbank.org/bootstrap" target="_blank">
                                                                <Button
                                                                    className="w-full h-12 bg-purple-600 hover:bg-purple-500 text-white font-bold text-xl"
                                                                >
                                                                    View Bootstrap Phase
                                                                </Button>
                                                            </Link>
                                                            <Dialog.Close asChild>
                                                                <button className="text-slate-500 hover:text-white text-sm font-medium transition-colors text-lg">
                                                                    Maybe later
                                                                </button>
                                                            </Dialog.Close>
                                                        </div>
