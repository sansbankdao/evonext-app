    ...
    const searchUsers = useCallback(async () => {
        ...
        try {
            ...
            if (searchResults.length > 0) {
                ...
                // Query EvoNext profiles for all these identities
                let profiles: any[] = []
                ...
                if (uniqueIdentityIds.length > 0) {
                    try {
                        ...
                        console.log('Found EvoNext profiles:', profiles)
                    } catch (error) {
                                                                            ...
                                                                            <TooltipProvider>
                                                                                <Tooltip>
                                                                                    ...
                                                                                    <TooltipContent side="top" className="max-w-xs">
                                                                                        <p>This user hasn&apos;t created a EvoNext profile yet, but you can still follow them. They&apos;ll see your follow when they join!</p>
                                                                                    </TooltipContent>
                                                                                </Tooltip>
                                                                            </TooltipProvider>
                                                                        )}
                                                                    ...
                                                                    {!followingUser.hasProfile && (
                                                                        <TooltipProvider>
                                                                            <Tooltip>
                                                                                ...
                                                                                <TooltipContent side="top" className="max-w-xs">
                                                                                    <p>This user hasn&apos;t created a EvoNext profile yet, but you&apos;re following them. They&apos;ll see your follow when they join!</p>
                                                                                </TooltipContent>
                                                                            </Tooltip>
                                                                        </TooltipProvider>
                                                                    )}
