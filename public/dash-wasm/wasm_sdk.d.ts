...
export function get_identity_keys(sdk: WasmSdk, identity_id: string, key_request_type: string, specific_key_ids?: Uint32Array | null, limit?: number | null, offset?: number | null): Promise<any>;
...
export function get_path_elements(sdk: WasmSdk, keys: string[]): Promise<any>;
...
export function get_contested_resources(sdk: WasmSdk, document_type_name: string, data_contract_id: string, index_name: string, result_type: string, _allow_include_locked_and_abstaining_vote_tally?: boolean | null, start_at_value?: Uint8Array | null, limit?: number | null, _offset?: number | null, order_ascending?: boolean | null): Promise<any>;
...
export function get_contested_resource_voters_for_identity(sdk: WasmSdk, data_contract_id: string, document_type_name: string, index_name: string, contestant_id: string, start_at_identifier_info?: string | null, count?: number | null, order_ascending?: boolean | null): Promise<any>;
export function get_contested_resource_identity_votes(sdk: WasmSdk, identity_id: string, limit?: number | null, offset?: number | null, order_ascending?: boolean | null): Promise<any>;
export function get_vote_polls_by_end_date(sdk: WasmSdk, start_time_ms?: bigint | null, end_time_ms?: bigint | null, limit?: number | null, offset?: number | null, order_ascending?: boolean | null): Promise<any>;
...
export interface InitOutput {
  ...
  readonly get_identity_keys: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => any;
  ...
  readonly get_path_elements: (a: number, b: number, c: number) => any;
  ...
  readonly get_contested_resource_voters_for_identity: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => any;
  readonly get_contested_resource_identity_votes: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
  readonly get_vote_polls_by_end_date: (a: number, b: number, c: bigint, d: number, e: bigint, f: number, g: number, h: number) => any;
  readonly start: () => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4e12a65029bb24b2: (a: number, b: number) => void;
  ...
  readonly closure2347_externref_shim: (a: number, b: number, c: any) => void;
