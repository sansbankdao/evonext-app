...
export const get_identity_keys: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => any;
...
export const get_path_elements: (a: number, b: number, c: number) => any;
...
export const get_contested_resource_voters_for_identity: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => any;
export const get_contested_resource_identity_votes: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
export const get_vote_polls_by_end_date: (a: number, b: number, c: bigint, d: number, e: bigint, f: number, g: number, h: number) => any;
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4e12a65029bb24b2: (a: number, b: number) => void;
...
export const closure2347_externref_shim: (a: number, b: number, c: any) => void;
export const closure4120_externref_shim: (a: number, b: number, c: any, d: any) => void;
