...
export function get_contested_resource_vote_state_with_proof_info(sdk: WasmSdk, data_contract_id: string, document_type_name: string, index_name: string, index_values: any[], result_type: string, allow_include_locked_and_abstaining_vote_tally?: boolean | null, start_at_identifier_info?: string | null, count?: number | null, _order_ascending?: boolean | null): Promise<any>;
...
export function get_contested_resource_vote_state(sdk: WasmSdk, data_contract_id: string, document_type_name: string, index_name: string, index_values: any[], result_type: string, allow_include_locked_and_abstaining_vote_tally?: boolean | null, start_at_identifier_info?: string | null, count?: number | null, _order_ascending?: boolean | null): Promise<any>;
/**
...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h478458ad7a13ba15: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h81e1ed597e600ff3: (a: number, b: number) => void;
  readonly closure2723_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure4465_externref_shim: (a: number, b: number, c: any, d: any) => void;
