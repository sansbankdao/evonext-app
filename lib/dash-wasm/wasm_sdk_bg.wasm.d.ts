...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h478458ad7a13ba15: (a: number, b: number) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h81e1ed597e600ff3: (a: number, b: number) => void;
export const closure2723_externref_shim: (a: number, b: number, c: any) => void;
export const closure4465_externref_shim: (a: number, b: number, c: any, d: any) => void;
