...
export function WalletHistory({ isFullScreen }: WalletHistoryProps) {
    ...
    return (
        <main className="pb-32 flex flex-col gap-4 text-slate-200">
            ...
            {txs.map((tx) => (
                ...
                >
                    ...
                    <h3 className="text-xs text-sky-600">
                        fee: {tx.fee}
                    </h3>
                    ...
                    <section className="my-3 px-2 py-1 flex flex-col gap-3 bg-gray-200 border border-gray-400 rounded">
                        <h2 className="text-xs text-sky-600 uppercase">
                            Inputs
                        </h2>

                        {displayInputs(tx.vin).map((input: Input) => (
                            <div key="input.outpoint" className="flex flex-col text-xs divide-sky-700">
                                <h3 className="text-xs text-sky-800 truncate">
                                    Outpoint:
                    ...
                    <section className="my-3 px-2 py-1 flex flex-col gap-3 bg-gray-700 border border-gray-900 rounded">
                        ...
                        {displayOutputs(tx.vout).map((output: Output) => (
                            <div key={output.outpoint} className="flex flex-col text-xs divide-sky-700">
