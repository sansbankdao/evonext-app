                                                    ...
                                                    <div className="sm:flex-1">
                                                        ...
                                                        <div className="mt-5 flex flex-wrap space-y-3 sm:space-x-3 sm:space-y-0">
                                                            ...
                                                            <div className="ml-3 inline-flex sm:ml-0">
                                                                <Menu id={menuId} as="div" className="relative inline-block text-left">
                                            ...
                                            <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                <div>
                                                    ...
                                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 dark:text-white">
                                                        <p>
                                                            Challenge yourself with the classic game with a geeky twist!
                                                            Rock, Paper, Scissors, Lizard, Spock expands on the original with two new options, adding more strategy and reducing the chance of ties.
                                                            Test your wits against our AI and see if you can master the new rules.
                                                        </p>
                                                    </dd>
                                                </div>
