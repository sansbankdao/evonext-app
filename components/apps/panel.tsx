                                    ...
                                    <div>
                                                    ...
                                                    <div className="sm:flex-1">
                                                        <div>
                                                            <div className="flex items-center">
                                                                <h3 className="text-xl font-bold text-gray-900 sm:text-2xl dark:text-white">Ashley Porter</h3>
                                                        ...
                                                        <div className="mt-5 flex flex-wrap space-y-3 sm:space-x-3 sm:space-y-0">
                                                            ...
                                                            <button
                                                                type="button"
                                                                className="inline-flex w-full flex-1 items-center justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-white/10 dark:text-gray-100 dark:shadow-none dark:ring-white/5 dark:hover:bg-white/20"
                                                            >
                                                                Call
                                                            </button>
                                        ...
                                        <div className="px-4 pb-5 pt-5 sm:px-0 sm:pt-0">
                                            <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                <div>
                                                    <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:shrink-0 dark:text-gray-400">Bio</dt>
                                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 dark:text-white">
                                                        <p>
                                                            Enim feugiat ut ipsum, neque ut. Tristique mi id elementum praesent. Gravida in tempus feugiat netus enim aliquet a, quam scelerisque. Dictumst in convallis nec in bibendum aenean
                                                            arcu.
                                                        </p>
                                                    </dd>
                                                </div>
                                                <div>
                                                    <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:shrink-0 dark:text-gray-400">Location</dt>
                                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 dark:text-white">New York, NY, USA</dd>
                                                </div>
                                                <div>
                                                    <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:shrink-0 dark:text-gray-400">Website</dt>
                                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 dark:text-white">ashleyporter.com</dd>
                                                </div>
                                                <div>
                                                    <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:shrink-0 dark:text-gray-400">Birthday</dt>
                                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 dark:text-white">
