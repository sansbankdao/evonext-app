...
async function registerContract() {
  try {
    ...
    const contractPath = '../dash-contract-cli/contracts/yappr-social-contract.json';
    ...
    if (contractId) {
      fs.writeFileSync('../dash-contract-cli/contracts/yappr-social-contract.contract-id', contractId);
